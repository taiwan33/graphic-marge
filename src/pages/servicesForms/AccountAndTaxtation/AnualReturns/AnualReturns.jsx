...
import { upload_document, upload_document_v2 } from "./AnualReturn";
      ...
      <form className="px-2">
        ...
        <div className="flex">
          <div className="border-primary-blue text-primary-red border px-10 text-lg font-bold">
            कम्पनीको वार्षिक विवरणको प्रकार
          </div>
          <div className="flex border-primary-blue text-primary-red border px-20 text-base font-bold sm:text-base">
            <div className="border-primary-blue bg-primary-red flex items-center justify-center gap-1 rounded-full border p-1 text-white">
              <label htmlFor="">
                अध्यावधिक पेपर सहितको कम्पनीको वार्षिक विवरण{" "}
              </label>
              <input type="radio" name="radio-btn" id="" />
            </div>
            <div className="border-primary-blue bg-primary-red flex items-center justify-center gap-1 rounded-full border p-1 text-white">
              <label htmlFor="">
                {" "}
                इलष्लिभ बाट निकालेको एबउभच मात्रको वार्षिक विवरण
              </label>
              <input type="radio" name="radio-btn" id="" />
            </div>
          </div>
        ...
        <div className="border-2 bg-pink-100 border-primary-blue mt-3">
          <p className="text-primary-blue mt-0 text-lg font-semibold leading-10 text-center">
            शेयर सदस्यहरुको संख्याको आधारमा अध्यावधिक सहितको वार्षिक विवरण पेश
        ...
        <div className="border-2 bg-pink-100 border-primary-blue mt-3">
          <p className="text-primary-blue mt-0 text-lg font-semibold leading-10 text-center">
            शेयर सदस्यहरुको संख्याको आधारमा अध्यावधिक सहितको वार्षिक विवरण पेश
            गर्दा तपाईको जम्मा लाग्ने रकम रु.५,०००।– मात्र
          </p>
        </div>
        ...
        <div className="text-primary-red text-lg underline mt-4">
          ...
          <span className="text-primary-blue underline">
            (३ महिने विवरण पेश गर्नको लागि आवश्यक पर्ने निम्न कागजपत्रहरु Upload
            गर्नुहोस ।)
          </span>
        </div>
