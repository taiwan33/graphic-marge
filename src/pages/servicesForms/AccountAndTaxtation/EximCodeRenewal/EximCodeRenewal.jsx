...
import { upload_document, upload_document_v2 } from "./EximCodeRenewals";

const EximCodeRenewal = () => {
  return (
    <div>
      <form className="px-2">
        ...
        <div className="border-2 bg-pink-100 border-primary-blue mt-3">
          <p className="text-primary-blue mt-0 text-lg font-semibold leading-10 text-center">
            ईक्जिम कोड नविकरण सम्बन्धि काम गर्दा शेवा शुल्क वापतको रकम
            रु.५,०००।– मात्र लाग्नेछ ।
          </p>
        </div>
        <div className=" border-primary-blue mt-3">
          <p className="flex text-primary-blue mt-0 font-semibold leading-10 text-center">
            ...
            ईक्जिम कोड नविकरण गर्दा नविकरण ढिला भएको समयको आधारमा राजश्व रकम थप
            लाग्नेछ ।
          </p>
        </div>

        {/* upload documents open */}
        <div className="text-primary-red flex text-lg underline mt-4">
          2. Upload Document
          <span className="text-primary-blue underline flex">
            (ईक्जिम कोड नविकरण गर्नको लागि आवश्यक पर्ने निम्न कागजपत्रहरु
            <p className="text-primary-red underline">Upload</p>
            गर्नुहोस ।)
          </span>
        </div>
        ...
        <div className="mt-4">
          ...
          <div className="border-2 bg-pink-100 border-primary-blue mt-3">
            <p className="text-primary-blue mt-0 text-lg font-semibold leading-10 text-center">
              वाणिज्य कार्यालयमा नविकरण सम्बन्धि काम गर्दा शेवा शुल्क वापतको रकम
              रु.५,०००।– मात्र लाग्नेछ ।
            </p>
          </div>
          ...
          <div className=" border-primary-blue mt-3">
            <p className="flex text-primary-blue mt-0 font-semibold leading-10 text-center">
              <p className=" text-primary-red mr-2">नोट :</p>ईक्जिम कोड नविकरण
              गर्दा नविकरण ढिला भएको समयको आधारमा राजश्व रकम थप लाग्नेछ ।
            </p>
          </div>
        </div>
        {/*note closed */}
        ...
        <div className=" border-primary-blue mt-3">
          <p className="flex items-center text-primary-blue mt-0 font-semibold leading-10 text-center">
            ...
            (ईक्जिम कोड नविकरण सम्बन्धि काम गर्नको लागि आवश्यक पर्ने निम्न
            कागजपत्रहरु
...
export default EximCodeRenewal;
