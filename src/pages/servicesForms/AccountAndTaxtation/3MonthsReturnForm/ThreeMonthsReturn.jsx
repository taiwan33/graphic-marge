...
import { upload_document, upload_document_v2 } from "./3MonthsReturnForm";

const ThreeMonthsReturn = () => {
  return (
    <div>
      <form className="px-10 lg:!px-14">
        ...
        <div className="border-2 bg-pink-100 border-primary-blue mt-3">
          <p className="text-primary-blue mt-0 text-lg font-semibold leading-10 text-center">
            शेयर सदस्यहरुको संख्याको आधारमा ३ महिने विवरण पेश गर्दा तपाईको जम्मा
            लाग्ने रकम रु.५,०००।– मात्र
          </p>
        </div>
        ...
        <div className="mt-4">
          ...
          <div className="border-2 bg-pink-100 border-primary-blue mt-3">
            <p className="text-primary-blue mt-0 text-lg font-semibold leading-10 text-center">
              शेयर सदस्यहरुको संख्याको आधारमा ३ महिने विवरण पेश गर्दा तपाईको
              जम्मा लाग्ने रकम रु.५,०००।– मात्र
            </p>
          </div>
...
export default ThreeMonthsReturn;
