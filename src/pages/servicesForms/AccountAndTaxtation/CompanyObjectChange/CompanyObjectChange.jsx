...
import { upload_document, upload_document_v2 } from "./CompanyObjectChanges";

const CompanyObjectChange = () => {
  return (
    <div>
      <form className="px-2">
        <p className="text-primary-red font-Rakkas mt-7 text-center text-xl font-semibold tracking-wide underline md:!text-2xl">
          Company Objective Change
        </p>
        ...
        <div className="border-2 bg-pink-100 border-primary-blue mt-3">
          <p className="text-primary-blue mt-0 text-lg font-semibold leading-10 text-center">
            शेयर सदस्यहरुको संख्याको आधारमा कम्पनीको उद्देश्यहरु थपघट सम्बन्धि
        ...
        <div className="mt-4">
          ...
          <div className="border-2 bg-pink-100 border-primary-blue mt-3">
            <p className="text-primary-blue mt-0 text-lg font-semibold leading-10 text-center">
              शेयर सदस्यहरुको संख्याको आधारमा कम्पनीको उद्देश्य थपघट सम्बन्धि
              काम गर्दा तपाईको जम्मा लाग्ने रकम रु.१५,०००।– मात्र
            </p>
          </div>
...
export default CompanyObjectChange;
