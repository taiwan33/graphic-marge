...
import { upload_document } from "./Share_Lagat_Provide_Form";
import { upload_document_v2 } from "./Share_Lagat_Provide_Form";

const ShareLagatProvideForm = () => {
  return (
    <div>
      <form className="px-2">
        ...
        <div className="border-2 bg-pink-100 border-primary-blue mt-3">
          <p className="text-primary-blue mt-0 text-lg font-semibold leading-10 text-center">
            शेयर सदस्यहरुको संख्याको आधारमा शेयर लगत निकाल्दा तपाईको जम्मा
            लाग्ने रकम रु.१२,०००।– मात्र
          </p>
        </div>
        ...
        <div className="mt-4">
          ...
          <div className="border-2 bg-pink-100 border-primary-blue mt-3">
            <p className="text-primary-blue mt-0 text-lg font-semibold leading-10 text-center">
              शेयर सदस्यहरुको संख्याको आधारमा कम्पनीको शेयर लगत सम्बन्धि काम
              गर्दा तपाईको जम्मा लाग्ने रकम रु.१२,०००।– मात्र
            </p>
          </div>
...
export default ShareLagatProvideForm;
