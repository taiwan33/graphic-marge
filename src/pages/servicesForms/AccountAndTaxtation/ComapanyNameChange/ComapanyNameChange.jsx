    ...
    <div>
      <form className="px-2">
        ...
        <div className="flex items-center">
          <div className="border-primary-blue py-2 text-primary-red border px-10 text-lg font-bold">
            अब परिवर्तन गर्ने कम्पनीको नाम
          </div>

          <div className="border-primary-blue flex items-center text-primary-red border px-20 text-base font-bold sm:text-lg">
            <p>नेपालीमा : </p>
        ...
        <div className="border-2 bg-pink-100 border-primary-blue mt-3">
          <p className="text-primary-blue mt-0 text-lg font-semibold leading-10 text-center">
            शेयर सदस्यहरुको संख्याको आधारमा कम्पनीको नाम परिवर्तन सम्बन्धि काम
            गर्दा तपाईको जम्मा लाग्ने रकम रु.२०,०००।– मात्र ।
          </p>
        </div>
        ...
        <div className="text-primary-red text-lg underline mt-4">
          ...
          <span className="text-primary-blue underline">
            (शेयर लगत निकाल्नको लागि आवश्यक पर्ने निम्न कागजपत्रहरु Upload
            गर्नुहोस ।)
          </span>
        </div>
...
export default ComapanyNameChange;
