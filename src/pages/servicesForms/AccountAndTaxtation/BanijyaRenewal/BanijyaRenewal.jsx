...
import { upload_document, upload_document_v2 } from "./BanijyaRenewals";

const BanijyaRenewal = () => {
  return (
    <div>
      <form className="px-2">
        ...
        <div className=" border-primary-blue mt-3">
          <p className="flex text-primary-blue mt-0 font-semibold leading-10 text-center">
            ...
            वाणिज्य कार्यालयमा दर्ता गर्दा तिरेको राजश्वको आधारमा राजश्व रकम थप
            लाग्नेछ ।
          </p>
        </div>
        ...
        <div className="mt-4">
          ...
          <div className=" border-primary-blue mt-3">
            <p className="flex text-primary-blue mt-0 font-semibold leading-10 text-center">
              <p className=" text-primary-red mr-2">नोट :</p> वाणिज्य कार्यालयमा
              दर्ता गर्दा तिरेको राजश्वको आधारमा राजश्व रकम थप लाग्नेछ ।
            </p>
          </div>
        </div>
        {/*note closed */}
        ...
        <div className=" border-primary-blue mt-3">
          <p className="flex items-center text-primary-blue mt-0 font-semibold leading-10 text-center">
            ...
            (वाणिज्यमा नविकरण सम्बन्धि काम गर्नको लागि आवश्यक पर्ने निम्न
            कागजपत्रहरु
