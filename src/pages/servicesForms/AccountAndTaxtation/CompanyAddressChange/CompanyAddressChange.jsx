...
import { upload_document, upload_document_v2 } from "./CompanyAddressChanges";
    ...
    <div>
      <form className="px-2">
        ...
        <div className="flex items-center">
          ...
          <div className="border-primary-blue flex items-center text-primary-red border text-base font-bold sm:text-lg">
        ...
        <div className="border-2 bg-pink-100 border-primary-blue mt-3">
          <p className="text-primary-blue mt-0 text-lg font-semibold leading-10 text-center">
            शेयर सदस्यहरुको संख्याको आधारमा कम्पनीको ठेगाना परिवर्तन सम्बन्धि
