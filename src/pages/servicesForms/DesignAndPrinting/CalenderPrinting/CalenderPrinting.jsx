          ...
          <form onSubmit={handleSubmit(onSubmit)} className="px-10 lg:!px-14">
            ...
            <div className="mt-5">
              ...
              <div className="flex justify-between">
                <p className=" text-lg ">
                  क्यालेन्डर छपाईको लागि निम्नुसारको विवरण भरेर अर्डर गर्नुहोस ।
                </p>
              ...
              <div className="mt-4">
                <div className="flex-col flex md:flex-row flex-wrap">
                  ...
                  क्यालेन्डर छाप्ने कम्पनी वा ब्यवसायको नाम :
                    </label>
                    <input
                      type="text"
...
export default CalenderPrinting;
