...
import {
  ...
  Trademark_Registration_v2,
  Trademark_Registration_v3,
  TradeMark_upload_details,
} from "./TrademarkRegistrationForm";
    ...
    <div>
      <form className="px-10 lg:!px-14">
        <p className=" text-primary-red text-xl font-semibold flex justify-center">
          Trademark (Brand) Registration Form(ट्रेडमार्क दर्ता गर्नको लागि)
        </p>
        ...
        <table className="mt-4">
          <thead>
            <tr>
              {Trademark_Registration_v2.map((item, i) => {
        ...
        <table className="mt-4">
          <thead>
            <tr>
              {Trademark_Registration_v3.map((item, i) => {
                const { name, validation, ip1, type } = item;
                console.log(item);
                return (
                  <div
        ...
        <table>
          ...
          <tbody>
            {TradeMark_upload_details.map((item, index) => {
              return (
