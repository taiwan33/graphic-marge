...
import NotRegisteredCompany from "../../../../components/common/forms/NotRegisteredCompany";
import OrderPage from "../../../../components/common/forms/OrderPage";
import {
  galeru_registration,
...
import {
  ward_registration,
  ward_registration_v2,
} from "../WardRegistrationForm";

const WardRegistrationA = () => {
  return (
    <div>
      <form className="px-10 lg:!px-14">
        <p className="text-primary-red font-Rakkas mt-7 text-center text-xl font-semibold tracking-wide underline md:!text-3xl">
          Ward Registration Form (ब्यक्तिगत वा साझेदारी नयाँ ब्यवसाय वडामा दर्ता
          गर्नको लागि)
        </p>
        ...
        <table className="mt-4">
          <thead>
            <tr>
              {ward_registration_v2.map((item, i) => {
                const { name, validation, ip1, type } = item;
                console.log(item);
                return (
                  <div
...
export default WardRegistrationA;
