...
import {
  ...
  banijiya_registration_upload_document_v3,
} from "../BanijyaCompanyRegistration/BanijiyaRegistrationForm";
import CompanySearch from "../../../../components/common/forms/CompanySearch";

const BanijyaCompanyRegistrationB = () => {
      ...
      <form className="px-10 lg:!px-14">
        ...
        <div>
          ...
          <div className="border-primary-blue max-w-3xl border font-bold">
            {banijiya_registration_business_details.map((item, i) => {
                    ...
                    <table id="tbl_posts">
                      <thead>
                        <tr>
                          ...
                          <td className="border-primary-blue text-primary-red border text-base font-bold sm:text-lg">
                            कम्पनीमा भएको शेयरको प्रतिशत
                          </td>
                          <td className="border-primary-blue text-primary-red border text-base font-bold sm:text-lg">
                            शेयर लगतमा भएको शेयर रकम
                          </td>
                          <td className="border-primary-blue text-primary-red border text-base font-bold sm:text-lg">
                            शेयर सदस्यको नागरिकता दुबै साईडतिरको
                          </td>
                          <td className="border-primary-blue text-primary-red border text-base font-bold sm:text-lg">
          ...
          <table>
            ...
            <tbody>
              {banijiya_registration_upload_document_v3.map((item, index) => {
                return (
                  <tr className="border-primary-blue border">
                    ...
                    <td>
                      <p className="border-primary-blue text-primary-blue font-semibold m-0 h-[54px] w-full border-r py-3 px-3 outline-none space-x-2">
                        {item.remark}
                      </p>
                    </td>
                  </tr>
...
export default BanijyaCompanyRegistrationB;
