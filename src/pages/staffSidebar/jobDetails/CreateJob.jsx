    ...
    <div className="">
      ...
      <div className="px-3 md:!px-10">
        ...
        <div className="my-5 grid place-content-center">
          <a
            className="bg-primary-green ml-10 rounded-md px-5 py-3 font-bold text-white"
            href=""
          >
            Go to user list
          </a>
          ...
          <div className="overflow-x-scroll sm:-mx-6 lg:-mx-8">
            <div className="inline-block min-w-full py-4 sm:px-6 lg:px-8">
              <div className="wrapper overflow-atuo">
                <table className="common border-primary-blue w-full border-collapse text-center">
                ...
                <div className="mt-3 md:max-w-[400px]">
                  ...
                  <div className="grid grid-cols-2">
                    <p className="text-primary-red border-primary-blue border-2 p-3 text-right font-semibold">
                      Total
                    </p>
                    <p className="border-primary-blue border-2 border-l-0 p-3 font-semibold">
                      0000
                    </p>
                  </div>
                  {/* discount */}
                  <div className="border-primary-blue grid grid-cols-2 border border-t-0">
                    <p className="text-primary-red border-primary-blue border p-3 text-right font-semibold">
                      Discount
                    </p>
                    <input
                      type="number"
                      className="border-primary-blue border px-2"
                      placeholder="Discount"
                    />
                  </div>
                  {/* grand total */}
                  <div className="border-primary-blue grid grid-cols-2 border border-t-0">
                    <p className="text-primary-red border-primary-blue border border-t-0 p-3 text-right font-semibold">
                      Grand Total
                    </p>
                    <p className="border-primary-blue border border-t-0 p-3 font-semibold">
                      000
                    </p>
                  </div>
                  {/* advance */}
                  <div className="border-primary-blue grid grid-cols-2 border border-t-0">
                    ...
                    <input
                      type="number"
                      className="border-primary-blue border border-t-0 px-2"
                      placeholder="Advance"
                    />
                  </div>
                  {/* dew balance */}
                  <div className="border-primary-blue grid grid-cols-2 border border-t-0">
                    ...
                    <p className="border-primary-blue border p-3 font-semibold">
                      000
                    </p>
                  </div>
                </div>
                {/* in word */}
                {/* dew balance */}
                <div className="border-primary-blue border-t-1 inline-flex items-center border-2">
                  <p className="text-primary-red p-3 text-right font-semibold">
                    In Words:
                  </p>
                  <p className="text-primary-green p-3 font-semibold">
                    Three thoushand three hundren only
                  </p>
                </div>
                {/* end calculation */}
                {/* submit button */}
                <div className="flex flex-wrap items-center">
                  ...
                  <div className="bg-primary-red ml-10 mt-3 inline-flex gap-2 rounded-md px-5 py-3 font-bold text-white">
                    <a href="">Print</a>
                  </div>
                </div>
